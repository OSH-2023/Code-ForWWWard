...
static const _ShmTopic_type_support_symbol_names_t _ShmTopic_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_shm_demo, msg, ShmTopic)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_shm_demo, msg, ShmTopic)),
  }
};
...
{
  return &::ros2_shm_demo::msg::rosidl_typesupport_cpp::ShmTopic_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_shm_demo, msg, ShmTopic)() {
  return get_message_type_support_handle<ros2_shm_demo::msg::ShmTopic>();
}
